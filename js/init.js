...
var matResume = function () {
	...
	/*Scrollspy*/
	var bodySel = $("#body");
	bodySel.scrollspy({ target: ".fjah-scroll-spy-1",offset:52 });
	var scollSpy2ActiveLI = "";
	bodySel.on('activate.bs.scrollspy', function () {
		if (scollSpy2ActiveLI != "") {
			scollSpy2ActiveLI.removeClass('active');            
		}        
		var activeTab = $('.fjah-scroll-spy-1 li.active a').attr('href');
		scollSpy2ActiveLI = $('.fjah-scroll-spy-2 li a[href="' + activeTab + '"]').parent();
